...
🔗 **Live Demo:**  
https://muhammederhan.github.io/CodeAlpha-Task1_Image-Gallery/
...
- 💡 **Interactive Lightbox** — Full-screen image preview with smooth transitions
- ◀️ **Previous / Next Navigation** — Navigate through the currently filtered images
- 📊 **Progress Indicator** — Visual indication of the current image position
- ⌨️ **Keyboard Navigation** — Enter, Space, Arrow keys, and Escape support
- 📱 **Mobile Swipe Gestures** — Swipe left/right to navigate through images
- 🖱️ **Click-Outside Close** — Close the lightbox by clicking the overlay
- ⚡ **Lazy Loading** — Images load as they approach the viewport
- 🚀 **Image Preloading** — Adjacent images are preloaded for smoother navigation
- ✨ **Micro-interactions** — Hover, focus, transitions, scaling, and loading animations
...
- Glassmorphism-inspired lightbox controls
